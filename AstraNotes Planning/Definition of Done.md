...
A task, feature, or artifact is complete only if **all** of the following are true:

- The work contributes directly or indirectly to one or more specific requirements.
- I fully understand the logic and design and could explain them to someone unfamiliar with the project.
- Some research on best practices is conducted and multiple options are considered.
